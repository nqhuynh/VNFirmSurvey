...
merge m:1 district2004 using "Convert 2004 district codes to 2003 district codes.dta"
drop if _merge==2
drop _merge
...
merge m:1 district2000 using "Convert 2000 district codes to 1999 district codes.dta"
drop if _merge==2
drop _merge
