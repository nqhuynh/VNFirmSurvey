...
- Sales shares of each cohort fall over time. Plus, the average sale shares of entering cohorts is smaller than the US  0.1082453. This can be due to high exit rate or falling of average size of incumbents or both. In the US, the former is true while the latter is not. Incumbents become larger over time in the US. 

```{r sale-share}
cohort_g[["Market Share"]]
```

- In Vietnam, the average size of surviving do not always increase. Both 2001 and 2005 cohorts experience a decline in their average size from 2005. 
...
- Exit rates are about the same as the US 
