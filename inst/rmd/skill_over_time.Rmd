...
result[, ID := paste0(province_2015, district_2015)]

temp <- merge(vn_shape, 
      result[, .N, by = 
               .(ID)])

result[province_2001 == "401", .N, by = district_2001]

setdiff(vn_shape$ID, temp$ID)
length(setdiff(vn_shape$ID, temp$ID))
```

2001 to check for merging with geo_dta 
